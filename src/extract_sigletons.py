...
def calculate_t(notinpair_gff_out, cutoff):
    ...
    with open(notinpair_gff_out, 'r') as fin: 
        ...
        print(f"Singleton: not_same_block_count = {not_same_block_count}, ")
        print(f"t1_count = {t1_count}, t2_count = {t2_count}")
...
def main(args):
    ...
    #                                + '.sigletons')
    #     parse_and_extract(input_file, output_file)

    # parse dag file
    dag_input_file = args[1]
    dag_output_file = args[2]
    parse_and_extract(dag_input_file, dag_output_file)

    # parse gff file
    gff_input_file = args[3]
    gff_output_file = args[4]
    ...
    cutoff = 86.6
    calculate_t(notinpair_gff_out, cutoff)
